...
class HardenedSessionBaseline:
    ...
    Present: session role binding, approval scope, revoke-at-effect-time, CAS,
    durable idempotency, durable mutable audit.
    Absent: persistent actor identity independent of session/provider,
    actor-bound authorization, fencing token, tamper-evident receipt proof.
    """
