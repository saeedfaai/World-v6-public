"""Registered Telegram transport adapter candidate.
...
class TelegramBotClient:
    ...
    This class is not callable from Entity private code. The canonical Executor
    must supply a committed Outbox effect after policy, approval, version and
    control_epoch rechecks.
    """
