"""Registered Google Drive archive reader candidate.

It is intentionally outside Entity private code. A registered Core read adapter
may fetch bytes; provenance is then carried into the canonical command/effect path.
Secrets/tokens must come from runtime secret injection or an injected client.
"""
